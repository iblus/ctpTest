...
char gMdFrontAddr[] = "tcp://218.202.237.33 :10012";               // 模拟行情前置地址

char *g_pInstrumentID[] = {"IF1806", "ru1805", "m1805", "TA805"}; // 行情合约代码列表，中、上、大、郑交易所各选一种
...
char gTradeFrontAddr[] = "tcp://218.202.237.33 :10002";            // 模拟交易前置地址

TThostFtdcInstrumentIDType g_pTradeInstrumentID = "IF1806";        // 所交易的合约代码
TThostFtdcDirectionType gTradeDirection = THOST_FTDC_D_Buy;       // 买卖方向
TThostFtdcPriceType gLimitPrice = 4038;                           // 交易价格
...
int main()
{
	...
	*/
	strcpy(gInvesterID, "113563");
	strcpy(gInvesterPassword, "12345678a");
	// 初始化行情线程
	cout << "初始化行情..." << endl;
